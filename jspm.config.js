SystemJS.config({
  paths: {
    ...
    "test-pixijs-systemjs-deprecation-warnings/": "src/"
  },
  browserConfig: {
    "baseURL": "/test-pixijs-systemjs-deprecation-warnings/"
  },
  devConfig: {
    "map": {
  ...
  packages: {
    "test-pixijs-systemjs-deprecation-warnings": {
      "main": "main.js",
      "meta": {
        "*.js": {
          "loader": "plugin-babel"
